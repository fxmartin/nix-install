...
description: Use proactively for real-time cryptocurrency market data retrieval and analysis
tools: WebSearch
---
...
1. Search for current market data for each of the following cryptocurrencies: BTC (Bitcoin), ETH (Ethereum), XRP (Ripple), SOL (Solana), BCH (Bitcoin Cash), LINK (Chainlink) and SUI (SUI)
