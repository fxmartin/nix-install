...
- Harden NAS backups with bounded iCloud materialization, per-attempt connectivity checks, isolated logs, actionable failure details, and staggered schedules
