...
**Status**: ✅ **v1.5.20 Released** - All 7 epics complete, ~78 hours development effort
...
This project is indexed by GitNexus as **nix-install** (11838 symbols, 18333 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
