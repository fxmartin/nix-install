...
- OpenCode wired to Ollama, llama-server and oMLX with per-backend launchers; retired-inferencers guardrail removed
...
- FluidVoice activation build can reach /usr/bin again (awk, unzip)

## [2.13.0] - 2026-08-06

### Added

- Self-updating casks pinned declaratively; no-auto-update policy now covered by tests

## [2.12.0] - 2026-08-06

### Added

- OpenUsage AI usage tracker declared across all profiles

## [2.11.0] - 2026-08-06

### Added

- Stats replaces the licensed iStat Menus; system-monitoring docs repaired after the btop retirement

## [2.10.0] - 2026-08-05

### Added

- Install patched FluidVoice fork (Auto-Enter per-app allowlist) at activation, replacing the upstream Homebrew cask
...
- Ollama server lifecycle and model pulls handed to the Local AI menubar app
...
- Perplexity retired from the managed app set; OpenCode LSP and local-inference memory budget stories added
...
- OpenCode routed to a local Ollama coding model on Power, with Qwen3.6 sampling parameters pinned via a derived Modelfile

## [2.3.0] - 2026-08-03

### Added

- Xcode via mas on Power profile; mactop replaces btop; gitlab-runner on Power; cmux from homebrew-core
...
- Replace btop with mactop for interactive monitoring; add nas-archive.sh bundle command; bump claude-code-config to v2.43.1 (fix-batch story-mirror exclusion, hermetic test registry)
...
- Add repository-owned signer trust for release tag verification

## [2.0.30] - 2026-07-28

### Fixed

- Update Darwin packages and maintenance settings

## [2.0.29] - 2026-07-27

### Fixed

- fail closed when release tag signer trust is unavailable

## [2.0.28] - 2026-07-27

### Fixed

- verify release tag signatures instead of assuming them

## [2.0.27] - 2026-07-27

### Fixed

- reject an unsigned same-commit tag in the release path

## [2.0.26] - 2026-07-27

### Fixed

- keep make release-* working now that bump-version tags
...
- extract and test the sdlc controller installer

## [2.0.23] - 2026-07-27

### Fixed

- deploy the sdlc controller pinned to uv.lock; init submodules on fresh installs

## [2.0.22] - 2026-07-27

### Fixed

- make the codex gate capability probe format-proof

## [2.0.21] - 2026-07-27

### Fixed

- enforce codex skill-mirror parity in CI; ship guarded sdlc fallback

## [2.0.20] - 2026-07-27

### Fixed

- regenerate codex build-stories skill from neutral source
...
- Include ignored user configuration in rebuild flakes
...
- Keep Calibre library local and harden update workflow
...
- sync claude-code-config: readme and gate-docs accuracy pass (claude-code-config PR #444)
...
- Continue inferencer cleanup after protected-target deletion failures.## [2.0.5] - 2026-07-13

### Fixed

- Keep pkgconf declarative when retiring oMLX dependencies.## [2.0.4] - 2026-07-13

### Fixed

- Consolidate local inference to Ollama and Apple-native MLX-LM with guarded legacy cleanup.## [2.0.3] - 2026-07-13

### Fixed

- Fix release monitor system checks and configurable flake paths## [2.0.2] - 2026-07-13

### Fixed

- Use the sanitized CI configuration for clean-checkout Nix evaluation## [2.0.1] - 2026-07-13
...
- Update Nix flake inputs## [1.9.9] - 2026-07-11

### Fixed

- bump claude-code-config submodule to v2.11.1 (deploy ordering fix, epic-27)## [1.9.8] - 2026-07-11
...
- Update Nix flake inputs## [1.9.4] - 2026-07-02

### Fixed

- Fix Codex activation command lookup during rebuild

## [1.9.3] - 2026-07-02

### Fixed

- Keep local-code-bench optional MLC wheel install from failing rebuilds

## [1.9.2] - 2026-07-02

### Fixed

- Fix OMLX Homebrew tap URL for Power-profile rebuilds

## [1.9.1] - 2026-07-02

### Fixed

- Update Nix flake inputs## [1.9.0] - 2026-07-02

### Added

- Add Power-profile local-code-bench inferencer deployment and remove GitNexus redeploy hook

## [1.8.4] - 2026-07-02

### Fixed

- Update Nix flake inputs## [1.8.3] - 2026-06-30

### Fixed

- Update Nix flake inputs## [1.8.2] - 2026-06-27

### Fixed

- Update Claude config submodule to the merged Qwen harness release.## [1.8.1] - 2026-06-27

### Fixed

- Fix markdown link checks to scan modified files only.## [1.8.0] - 2026-06-27

### Added

- Add agent harness privacy controls, Qwen harness support, and iCloud sync validation.
...
- Update Nix flake inputs## [1.7.1] - 2026-06-23
...
- Add local bench servers and disable Ollama autostart## [1.6.2] - 2026-06-21
...
- Update Nix flake inputs## [1.6.0] - 2026-06-16
...
- Add SSH alias for MacBook Pro M1## [1.5.47] - 2026-06-16
...
- Update story progress and install OpenCode## [1.5.45] - 2026-06-15

### Fixed

- Clean repo health gates and shell defaults## [1.5.44] - 2026-06-15

### Fixed

- Update Nix flake inputs## [1.5.43] - 2026-06-13

### Fixed

- Update Nix flake inputs## [1.5.42] - 2026-06-12

### Fixed

- Update Nix flake inputs## [1.5.41] - 2026-06-12
...
- machine-local Claude Code model via ANTHROPIC_MODEL; claude-code-config submodule fixes (submodule init in installer/CI, template model ids, tests merge)## [1.5.35] - 2026-06-11

### Fixed

- Update Nix flake inputs## [1.5.34] - 2026-06-09

### Fixed

- Remove AeroSpace and SketchyBar config; add Raycast cask## [1.5.33] - 2026-06-09

### Fixed

- Update Nix flake inputs## [1.5.32] - 2026-06-07

### Fixed

- Update Nix flake inputs## [1.5.31] - 2026-06-05

### Fixed

- Fix GTK4 theme conflict## [1.5.30] - 2026-06-05

### Fixed

- Update Nix flake inputs## [1.5.29] - 2026-06-03

### Fixed

- Update Nix flake inputs## [1.5.28] - 2026-06-02

### Fixed

- Suppress Stylix Home Manager release warning## [1.5.27] - 2026-06-02

### Fixed

- Update Nix flake inputs## [1.5.26] - 2026-05-28

### Fixed

- Update Nix flake inputs## [1.5.25] - 2026-05-27

### Fixed

- Simplify SketchyBar system widgets## [1.5.24] - 2026-05-27

### Fixed

- Set VS Code default theme to Catppuccin Latte## [1.5.23] - 2026-05-27

### Fixed

- Route Music to the Misc workspace## [1.5.22] - 2026-05-27
...
- Update Nix flake inputs## [1.5.18] - 2026-05-25

### Fixed

- Update Nix flake inputs## [1.5.17] - 2026-05-23

### Fixed

- Update Nix flake inputs## [1.5.16] - 2026-05-22

### Fixed

- Update Nix flake inputs## [1.5.15] - 2026-05-21

### Fixed

- Disable rebuild-time Ollama model pulls by default## [1.5.14] - 2026-05-21

### Fixed

- Update Nix flake inputs## [1.5.13] - 2026-05-20

### Fixed

- Update Nix flake inputs## [1.5.12] - 2026-05-19

### Fixed

- Update Nix flake inputs## [1.5.11] - 2026-05-18

### Fixed

- Add guarded Ollama start and stop scripts for external-drive models

## [1.5.10] - 2026-05-18

### Fixed

- Update Nix flake inputs## [1.5.9] - 2026-05-15
...
- Remove Arc and Dropbox from managed application profile## [1.5.7] - 2026-05-15

### Fixed

- Update Nix flake inputs## [1.5.6] - 2026-05-13
...
- Update Nix flake inputs## [1.5.4] - 2026-05-11
...
- Update Nix flake inputs## [1.5.2] - 2026-05-09

### Fixed

- Update Codex and Zed settings## [1.5.1] - 2026-05-09

### Fixed

- Bump claude-code-config: create-story now infers target epic and gates too-large requirements toward /create-epic.## [1.5.0] - 2026-05-08

### Added

- Add EDIFIER ConneX Mac App Store app## [1.4.2] - 2026-05-08

### Fixed

- Update Nix flake inputs## [1.4.1] - 2026-05-07

### Fixed

- Fix privacy-filter runtime model and response schema## [1.4.0] - 2026-05-07

### Added

- Add local MLX privacy-filter daemon and redaction helpers## [1.3.2] - 2026-05-07

### Fixed

- Update Nix flake inputs## [1.3.1] - 2026-05-06

### Fixed

- Update Nix flake inputs## [1.3.0] - 2026-05-05

### Added

- Add ccusage, Work workspace, and Sequoia Sunrise screensaver## [1.2.2] - 2026-05-04
