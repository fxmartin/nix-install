...
#   ./setup.sh
#
# This is an adaptation of the repository https://github.com/mlgruby/dotfile-nix/tree/main
...
# Configuration
REPO_URL="https://raw.githubusercontent.com/fxmartin/nix-install/main"
...
main() {
    ...
    if [[ "${CI:-false}" == "true" ]] || [[ "$1" == "--yes" ]] || [[ "$1" == "-y" ]]; then
        ...
        echo -e "${BLUE}  curl -o setup.sh https://raw.githubusercontent.com/fxmartin/nix-install/main/setup.sh${NC}"
