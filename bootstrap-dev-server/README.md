...
```bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USER/YOUR_REPO/main/bootstrap-dev-server.sh | bash
```
...
# Custom SSH port
curl -fsSL https://raw.githubusercontent.com/YOUR_USER/YOUR_REPO/main/bootstrap-dev-server.sh | SSH_PORT=2222 bash

# Regenerate SSH host keys (fresh install)
curl -fsSL https://raw.githubusercontent.com/YOUR_USER/YOUR_REPO/main/bootstrap-dev-server.sh | REGEN_HOST_KEYS=true bash
```
