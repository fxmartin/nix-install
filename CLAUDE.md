...
**Status**: ✅ **v1.5.32 Released** - All 7 epics complete, ~78 hours development effort
...
This project is indexed by GitNexus as **nix-install** (11895 symbols, 20793 relationships, 295 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
